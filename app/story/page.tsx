  ...
  return (
    <>
      ...
      <section className="prose-section" aria-label="Now">
        ...
        <div className="prose">
          <p>
            ...
            increasingly end to end: agents that study your product, script it,
            record it in a real browser, and re-render when the code changes.
          </p>
          <p>
            Most of what I know comes from shipping agents to production and
            building the infra underneath them. The rest comes from small tools
            nobody asked for.
          </p>
        </div>
      </section>
      ...
      <section className="prose-section" aria-label="The deep end">
        ...
        <div className="prose">
          <p>
            ...
            engineer and got handed the fun kind of problem: build the entire AI
            backend for a cloud automation platform, from nothing.
          </p>
          <p>
            That turned into a multi-agent DAG orchestrator with eight agent
            types, an MCP server built while the protocol was five weeks old, a
            knowledge-graph and RAG stack that did most of its entity extraction
            locally, semantic memory on pgvector, a fine-tuned model for
            constraint extraction, and the OTel plumbing to know what all of it
            cost. I was also primary on-call, which is a very effective way to
            learn which of your ideas were bad.
          </p>
        </div>
      </section>
      ...
      <section className="prose-section" aria-label="How it started">
        ...
        <div className="prose">
          <p>
            ...
            specialization. The part that actually mattered: leading a team that
            built an autonomous medicine-delivery robot for hospitals. Raspberry
            Pi, obstacle detection, path following, RFID room identification. It
            ended up published in{' '}
            ...
            to tell ripe crops from unripe ones, and it shipped to production at
      ...
      <section className="prose-section" aria-label="Off the clock">
        ...
        <div className="prose">
          <p>
            I ship small tools compulsively. A docker clone for macOS started as
            an overnight bet and ended up on Homebrew. Most of what I make lives
            in the terminal, because that&apos;s where I live too.
          </p>
          <p>
            ...
            , and watching football. Lamine Yamal will win everything, you heard
            it here.
          </p>
        </div>
      </section>
